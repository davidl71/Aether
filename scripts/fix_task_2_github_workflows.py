#!/usr/bin/env python3
"""
Fix broken links in GITHUB_WORKFLOWS.md (Task 2)
Runs in background to fix EXARP_FASTMCP_CONFIGURATION.md link
"""
        ...
        if target_line_num <= len(lines):
            ...
            if 'EXARP_FASTMCP_CONFIGURATION.md' in line:
                ...
                if similar_file:
                    ...
                    # File doesn't exist - remove link or comment it out
                    # Since it's in "Related Documentation", we can remove the line or comment it
