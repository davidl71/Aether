...
echo ""
echo "Next steps:"
echo "1. Start Rust backend/TUI (e.g. cd agents/backend && cargo run -p tui_service) and use config for IB connection"
echo "2. Accept connection in TWS popup (if prompted)"
echo "3. Check logs for connection confirmation"
