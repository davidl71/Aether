...
5. **Tests:** All trading logic and risk calculations must have tests (Rust `#[test]` modules/integration tests for active code). Do not skip tests for risk/order code.
