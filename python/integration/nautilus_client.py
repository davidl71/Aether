"""
nautilus_client.py - NautilusTrader client wrapper for Interactive Brokers
"""
import logging
...
class NautilusClient:
    """
    Wrapper for NautilusTrader IB adapter providing market data and execution.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            venue: Trading venue identifier (default: "IB")
        """
    ...
    def create_data_client(self) -> LiveDataClient:
        ...
        if not self.data_client:
            # Convert dict config to NautilusTrader config
        ...
        try:
            ...
            if self.notifier:
                self.notifier.notify(
                    ...
                    title="IB connection established",
        ...
        try:
            ...
            if self.notifier:
                self.notifier.notify(
                    ...
                    title="Error during IB disconnect",
                    message=str(e),
                    severity="warning",
                )
