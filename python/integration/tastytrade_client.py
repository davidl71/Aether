...
class TastytradeClient:
    ...
    def __init__(
        ...
        # OAuth credentials (preferred); optional 1Password op:// refs via SDK
        self.client_secret = client_secret or getenv_or_resolve("TASTYTRADE_CLIENT_SECRET", "OP_TASTYTRADE_CLIENT_SECRET_SECRET", "")
        self.refresh_token = refresh_token or getenv_or_resolve("TASTYTRADE_REFRESH_TOKEN", "OP_TASTYTRADE_REFRESH_TOKEN_SECRET", "")
        self._use_oauth = bool(self.client_secret and self.refresh_token)

        # Session-based credentials (fallback); optional 1Password op:// refs via SDK
        self.username = username or getenv_or_resolve("TASTYTRADE_USERNAME", "OP_TASTYTRADE_USERNAME_SECRET", "")
        self.password = password or getenv_or_resolve("TASTYTRADE_PASSWORD", "OP_TASTYTRADE_PASSWORD_SECRET", "")
