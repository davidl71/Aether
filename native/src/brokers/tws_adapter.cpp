...
types::OptionContract TWSAdapter::convert_contract(const box_spread::types::OptionContract& contract) {
    ...
    result.style = static_cast<types::OptionStyle>(static_cast<int>(contract.style));
    result.exchange = contract.exchange;
    result.local_symbol = contract.local_symbol;
    return result;
}

box_spread::types::OptionContract TWSAdapter::convert_contract_back(const types::OptionContract& contract) {
    box_spread::types::OptionContract result;
    result.symbol = contract.symbol;
    result.expiry = contract.expiry;
    result.strike = contract.strike;
    result.type = static_cast<box_spread::types::OptionType>(static_cast<int>(contract.type));
    result.style = static_cast<box_spread::types::OptionStyle>(static_cast<int>(contract.style));
    result.exchange = contract.exchange;
    result.local_symbol = contract.local_symbol;
    return result;
}

types::OrderAction TWSAdapter::convert_action(box_spread::types::OrderAction action) {
    return static_cast<types::OrderAction>(static_cast<int>(action));
}

box_spread::types::OrderAction TWSAdapter::convert_action_back(types::OrderAction action) {
...
box_spread::types::TimeInForce TWSAdapter::convert_tif_back(types::TimeInForce tif) {
    return static_cast<box_spread::types::TimeInForce>(static_cast<int>(tif));
}

types::MarketData TWSAdapter::convert_market_data(const box_spread::types::MarketData& data) {
...
box_spread::types::MarketData TWSAdapter::convert_market_data_back(const types::MarketData& data) {
...
types::Order TWSAdapter::convert_order(const box_spread::types::Order& order) {
    ...
    result.status = static_cast<types::OrderStatus>(static_cast<int>(order.status));
...
box_spread::types::Order TWSAdapter::convert_order_back(const types::Order& order) {
    ...
    result.status = static_cast<box_spread::types::OrderStatus>(static_cast<int>(order.status));
    result.submitted_time = order.submitted_time;
    result.last_update = order.last_update;
    result.filled_quantity = order.filled_quantity;
    result.avg_fill_price = order.avg_fill_price;
...
types::Position TWSAdapter::convert_position(const box_spread::types::Position& position) {
...
box_spread::types::Position TWSAdapter::convert_position_back(const types::Position& position) {
...
types::AccountInfo TWSAdapter::convert_account_info(const box_spread::types::AccountInfo& info) {
...
box_spread::types::AccountInfo TWSAdapter::convert_account_info_back(const types::AccountInfo& info) {
...
tws::ConnectionState TWSAdapter::convert_connection_state(box_spread::brokers::ConnectionState state) {
    return static_cast<tws::ConnectionState>(static_cast<int>(state));
}

box_spread::brokers::ConnectionState TWSAdapter::convert_connection_state_back(tws::ConnectionState state) {
    return static_cast<box_spread::brokers::ConnectionState>(static_cast<int>(state));
}
...
int TWSAdapter::request_market_data(
    ...
    return tws_client_->request_market_data(
        native_contract,
        [callback](const types::MarketData& data) {
...
std::optional<box_spread::types::MarketData> TWSAdapter::request_market_data_sync(
    const box_spread::types::OptionContract& contract,
    int timeout_ms
) {
    std::lock_guard<std::mutex> lock(mutex_);
    ...
    auto native_data = tws_client_->request_market_data_sync(native_contract, timeout_ms);
    if (native_data) {
...
std::vector<box_spread::types::OptionContract> TWSAdapter::request_option_chain(
...
long TWSAdapter::request_contract_details_sync(
    ...
    std::lock_guard<std::mutex> lock(mutex_);
    types::OptionContract native_contract = convert_contract(contract);
    return tws_client_->request_contract_details_sync(native_contract, timeout_ms);
}
...
int TWSAdapter::place_order(
    ...
    std::lock_guard<std::mutex> lock(mutex_);
    types::OptionContract native_contract = convert_contract(contract);
    return tws_client_->place_order(
        native_contract,
...
std::optional<box_spread::types::Order> TWSAdapter::get_order_status(int order_id) const {
    std::lock_guard<std::mutex> lock(mutex_);
...
int TWSAdapter::place_combo_order(
    ...
    return tws_client_->place_combo_order(
        native_contracts,
        native_actions,
        quantities,
        contract_ids,
...
std::optional<box_spread::types::Position> TWSAdapter::get_position(
    const box_spread::types::OptionContract& contract
) {
    std::lock_guard<std::mutex> lock(mutex_);
    types::OptionContract native_contract = convert_contract(contract);
