...
public:
    ...
    void tickPrice(TickerId tickerId, TickType field,
        ...
        spdlog::trace("tickPrice: id={}, field={}, price={}",
    ...
    void tickSize(TickerId tickerId, TickType field, Decimal size) override {
        spdlog::trace("tickSize: id={}, field={}, size={}",
                     tickerId, field, size);
    ...
    void orderStatus(OrderId orderId, const std::string& status,
        ...
        spdlog::info("Order #{} status: {}, filled={}, remaining={}",
    ...
    void execDetails(int reqId, const Contract& contract,
        ...
        spdlog::info("Execution: order={}, shares={}, price={}",
    ...
    void position(const std::string& account, const Contract& contract,
        ...
        spdlog::debug("Position: {} {} @ {}",
                     position, contract.symbol, avgCost);
    ...
    void updatePortfolio(const Contract& contract, Decimal position,
        ...
        spdlog::debug("Portfolio update: {} position={}, PnL={}",
                     contract.symbol, position, unrealizedPNL);
    ...
    void error(int id, int errorCode, const std::string& errorString,
        ...
        if (errorCode >= 2100 && errorCode < 3000) {
            ...
            // Errors
            spdlog::error("TWS error {} (id={}): {}",
                         errorCode, id, errorString);
