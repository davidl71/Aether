...
- **TWS API Path**: `native/third_party/tws-api/IBJts/source/cppclient/client/`
- **Intel Decimal Instructions**: `native/third_party/tws-api/IBJts/source/cppclient/Intel_lib_build.txt`
- **Protocol Buffer Files**: Already generated in `native/third_party/tws-api/IBJts/source/cppclient/client/*.pb.{h,cc}`
