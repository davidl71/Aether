...
| Theme | Key docs |
|-------|----------|
| **TUI** | TUI_LEGACY_DESIGN_LEARNINGS.md, TUI_CLI_FEATURE_PARITY.md, TUI_RUST_READ_PATH_AUDIT.md, TUI_DESIGN.md, TUI_SCENARIO_EXPLORER_DESIGN.md, TUI_MULTISCREEN_RESEARCH.md, TICKER_TUI_ANALYSIS.md, TUI_BREADCRUMB_LOGGING.md |
