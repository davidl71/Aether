...
For repo-local cache and temp overrides used by scripts and agent runs, see [SANDBOX_FRIENDLY_OVERRIDES.md](/Users/davidl/Projects/Trading/Aether/docs/SANDBOX_FRIENDLY_OVERRIDES.md).
