...
1. Go to repository: https://github.com/davidl71/Aether
...
git remote set-url origin git@github.com:davidl71/Aether.git
...
# https://github.com/davidl71/Aether/actions
```
