...
1. **T-13**: Complete Web app missing features
2. **T-14**: Complete TUI missing features
3. **T-15**: Implement WebSocket support

### Long-Term (Lower Priority)

1. **T-17**: Prototype Go QuestDB microservice
2. **T-18**: Design Go build-coordinator
3. **T-19**: Design iPad frontend architecture
4. **T-20**: Implement iPad backend endpoints
5. **T-21**: Design web SPA architecture
