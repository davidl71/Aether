...
```bash
ssh davidl@192.168.192.141 "cd /Users/davidl/Projects/Trading/Aether && bash scripts/setup_github_runner_macos.sh https://github.com/YOUR_USERNAME/YOUR_REPO YOUR_TOKEN macos-m4-agent"
```
...
ssh davidl@192.168.192.141 "cd /Users/davidl/Projects/Trading/Aether && python3 scripts/collect_system_info_python.py" > system_info_macos.json
...
ssh davidl@192.168.192.141 "cd /Users/davidl/Projects/Trading/Aether && pwd && ls -la"
...
```bash
ssh davidl@192.168.192.141 "cd /Users/davidl/Projects/Trading/Aether && bash scripts/run_tests.sh"
```

### Build Project

```bash
ssh davidl@192.168.192.141 "cd /Users/davidl/Projects/Trading/Aether && cmake --build build"
```

### Pull Latest Changes

```bash
ssh davidl@192.168.192.141 "cd /Users/davidl/Projects/Trading/Aether && git pull origin main"
```
