...
- heartbeat aggregation: Rust-exposed path backed by Rust `system.health` consumption
...
3. Do not reintroduce a separate Python or Go health aggregation daemon unless Rust ownership is intentionally reversed.
