...
All task-store state for this repo lives under [`/.todo2`](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2):

| Path | Role |
|------|------|
| [`.todo2/todo2.db`](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2/todo2.db) | Primary SQLite task store |
| [`.todo2/todo2.db-wal`](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2/todo2.db-wal) | SQLite WAL sidecar |
| [`.todo2/todo2.db-shm`](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2/todo2.db-shm) | SQLite shared-memory sidecar |
| [`.todo2/state.todo2.json`](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2/state.todo2.json) | JSON snapshot / fallback store |
| [`.todo2/handoffs.json`](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2/handoffs.json) | Session handoff store |
...
|------|------|------|
| [scripts/run_exarp_go.sh](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/scripts/run_exarp_go.sh) | Resolves `exarp-go`, exports `PROJECT_ROOT`, optionally sets `EXARP_MIGRATIONS_DIR`, then `exec`s the binary | Indirect: routes all exarp-go access to the right repo |
| [scripts/run_exarp_go_tool.sh](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/scripts/run_exarp_go_tool.sh) | Convenience wrapper for `-tool <name> -args <json>` | Indirect |
...
|------|------|------|------|
| `exarp-go task sync` | none or [run_exarp_go.sh](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/scripts/run_exarp_go.sh) | `initializeDatabase()` -> `handleTaskCommand()` -> `handleTaskSync()` -> `task_workflow(action=sync)` -> `SyncTodo2Tasks()` | `todo2.db`, `state.todo2.json` |
...
| `-tool task_workflow {"action":"sync","sub_action":"list"}` | [run_exarp_go_tool.sh](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/scripts/run_exarp_go_tool.sh) or MCP | `initializeDatabase()` -> `server.CallTool("task_workflow", ...)` -> `getTaskStore()` / `SyncTodo2Tasks()` | `todo2.db`, `state.todo2.json` |
...
- Do not edit [state.todo2.json](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/.todo2/state.todo2.json) manually; use exarp-go.

## References

- [scripts/run_exarp_go.sh](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/scripts/run_exarp_go.sh)
- [scripts/run_exarp_go_tool.sh](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/scripts/run_exarp_go_tool.sh)
- [EXARP_TODO2_DB_INIT.md](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/docs/EXARP_TODO2_DB_INIT.md)
- [EXARP_GO_SIBLING_CI_AND_AI_PATTERNS.md](/Users/davidl/Projects/Trading/ib_box_spread_full_universal/docs/EXARP_GO_SIBLING_CI_AND_AI_PATTERNS.md)
